...
cmd:text()
cmd:text('Options')
cmd:option('-input_json','../data/fvqa_data_prepro.json','path to the json file containing vocab and answers')
cmd:option('-image_root','/home/medhini2/HieCoAttenVQA/data/FVQA_DATA/','path to the image root')
...
cmd:option('-out_name_train', '../data/feats/fvqa_data_img_vgg_train.h5', 'output name train')
cmd:option('-out_name_test', '../data/feats/fvqa_data_img_vgg_test.h5', 'output name test')
